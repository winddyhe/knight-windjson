...
namespace Test
{
    public class JsonParseTest : MonoBehaviour
    {
        ...
        private void Test2()
        {
            string rText = File.ReadAllText("Assets/Plugins/WindJson/Test/Test1.txt");
        ...
        void Test1()
        {
            JsonParser rJsonParser = new JsonParser(File.ReadAllText("Assets/Plugins/WindJson/Test/Test1.txt"));
            Debug.Log(rJsonParser.PretreatmentProc());
